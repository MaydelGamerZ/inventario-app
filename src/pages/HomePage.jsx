...
/**
 * Home page shown after login. Displays user info and a summary of the
 * application state. Serves as a dashboard stub.
 */
  ...
  return (
    <div>
      <header className="mb-8">
        ...
        <p className="mt-2 text-zinc-400">Bienvenido al sistema de inventario.</p>
      </header>
